 ...
 *
 * Copyright (c) 2006 - 2008 Jaorn Zaefferer
 *
                 ...
                 if($valor){
                   ...
                   if($valor.match(expReg)){
                                 ...
                                 if(($mes==4 && $dia>30) || ($mes==6 && $dia>30) || ($mes==9 && $dia>30) || ($mes==11 && $dia>30)){
                                   $erro = "Data incorreta! O m&ecirc;s especificado na data "+$valor+" cont&eacute;m 30 dias.";
                                 }else{
                                   if($ano%4!=0 && $mes==2 && $dia>28){
                                                 $erro = "Data incorreta!! O m&ecirc;s especificado na data "+$valor+" cont&eacute;m 28 dias."
                                   }else{
                                                 if($ano%4==0 && $mes==2 && $dia>29){
                                                   $erro = "Data incorreta!! O m&ecirc;s especificado na data "+$valor+" cont&eacute;m 29 dias.";
                                                 }
                                   }
                                 }
                   }else{
